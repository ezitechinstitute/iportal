    ...
    const fetchCounts = async () => {
      try {
        ...
        const reviewResponse = await fetch(
          "https://api.ezitech.org/count-pending-review"
        );
        ...
        const nonReviewResponse = await fetch(
          "https://api.ezitech.org/count-approved-review"
        );
                ...
                <div className="card2">
                  <div className="card py-2">
                    ...
                    <div className="card-body pl-1 mt-1">
                      <h4
                        className=""
                        style={{ marginBottom: "5px", width: "max-content" }}
                      >
                        Pending Feedbacks
                      </h4>
                      <p
