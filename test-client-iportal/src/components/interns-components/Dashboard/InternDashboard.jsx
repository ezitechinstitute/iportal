          ...
          <section id="dashboard-ecommerce">
            ...
            <div class="container-fluid" style={{ margintop: "-5px" }} >
              <div class=" row col-lg-12">
                <marquee style={{ color: "#f88a1b" }}><p class="marquee"
                >14th Year Anniversary.<span class="ezi">Ezitech Institute</span> has completed 14 years.3963 has completed their internship.Thanks all for yours unconditional support</p></marquee>
              ...
              <div class="row">
                <div class="col-lg-8 col-12" >
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div>
                        <div class="card1" style={{ width: "220px", boxshadow: "0px 4px  #eae8fd", marginright: "10px" }}>
                          <div class="card py-2">
                            <div class="d-flex">
                              <i class=" icon px-1 mx-1" style={{ color: "#776cf0", backgroundcolor: "#eae8fd", borderradius: "5px", padding: "4px 5px" }}><i data-feather="grid"></i></i>
                              <h3>0</h3>
                            </div>
                            <div class="card-body pl-1 mt-1">
                              <h4 class="card-title" style={{ marginbottom: "5px" }}>Total Projects</h4>
                              <p class="card-text" style={{ display: "flex", paddingbottom: "0%", margintop: "14px" }}>
                                3.5% Total Progress
                              </p>
                            </div>
                          </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div>
                        <div class="card2 " style={{
                          width: "220px", boxshadow: "0px 4px #fff1e3",
                          marginright: "18px"
                        }}>
                          <div class="card py-2">
                            <div class="d-flex">
                              <i class=" icon px-1 mx-1" style={{
                                color: "#ffa146",
                                backgroundcolor: "#fff1e3",
                                borderradius: "5px",
                                padding: "4px 5px"
                              }}><i data-feather='loader'></i></i>
                              <h3>0</h3>
                            </div>
                            <div class="card-body pl-1 mt-1">
                              <h4 class="card-title" style={{ marginbottom: "5px" }}>In Progress</h4>
                              <p class="card-text" style={{ display: "flex", paddingbottom: "0%", margintop: "14px" }}>
                                3.5% Total Progress
                              </p>
                            </div>
                          ...
                          <div class="card py-2">
                            <div class="d-flex">
                              <i class=" icon px-1 mx-1" style={{
                                ...
                                borderradius: "5px",
                                padding: "4px 5px"
                              }}><i data-feather='menu'></i></i>
                              <h3>0</h3>
                            </div>
                            <div class="card-body pl-1 mt-1">
                              <h4 class="card-title" style={{ marginbottom: "5px" }}>Complete Projects</h4>
                              <p class="card-text" style={{ display: "flex", paddingbottom: "0%", margintop: "14px" }}>
                                3.5% Total Progress
                              </p>
                            </div>
                          ...
                          <div class="card py-2">
                            <div class="d-flex">
                              <i class=" icon px-1 mx-1" style={{
                                ...
                                borderradius: "5px",
                                padding: "4px 5px"
                              }}><i data-feather='check-square'></i></i>
                              <h3>0</h3>
                            </div>
                            <div class="card-body pl-1 mt-1">
                              <h4 class="card-title" style={{ marginbottom: "5px" }}>Total Attendence</h4>
                              <p class="card-text" style={{ display: "flex", paddingbottom: "0%", margintop: "14px" }}>
                                0 Last Week
                              </p>
                            </div>
                          ...
                          <div class="card py-2">
                            <div class="d-flex">
                              <i class=" icon px-1 mx-1" style={{
                                ...
                                borderradius: "5px",
                                padding: "4px 5px"
                              }}><i data-feather='coffee'></i></i>
                              <h3>0</h3>
                            </div>
                            <div class="card-body pl-1 mt-1">
                              <h4 class="card-title" style={{ marginbottom: "5px" }}>Holidays</h4>
                              <p class="card-text" style={{ display: "flex", paddingbottom: "0%", margintop: "14px" }}>
                                0 Last Week
                              </p>
                            </div>
                      ...
                      <div>
                        <div class="card6" style={{
                          ...
                          <div class="card py-2">
                            ...
                            <div class="card-body pl-1 mt-1">
                              <h4 class="card-title" style={{ marginbottom: "5px" }}>Leaves</h4>
                              <p class="card-text" style={{ display: "flex", paddingbottom: "0%", margintop: "14px" }}>
                                0 Last Week
                              </p>
                            </div>
                ...
                <div class="cardd col-lg-4 col-md-6 col-12">
                  <div class="card card-congratulation-meda">
                    <div class="card-body">
                      <h5 class="notes mb-5 mr-1" style={{
                        marginleft: "20px",
                        fontsize: "23px"
                      }}>Notifications</h5>

                      <div class="card-footer">
                        <button type="button" class="wattsapp btn btn-success px-2" style={{
                          margintop: "25px",
                          marginleft: "1px"
                        }}>Join Wattsapp Group</button>
                      </div>
                      ...
                      <div class="card-footer ">
                        ...
                        <div class="d-flex">
                          <p class=" tags mb-75 mt-2 pt-50 " style={{
                            marginleft: "3px",
                            marginright: "3px",
                          ...
                          <div class="column">
                            ...
                            <div class="d-flex mt-2 ml-2">
                              <div class="icon mr-2 mt-1">
                                <i class=" icon1 px-1 mr-1" style={{
                                  color: "#776cf0",
                                  backgroundcolor: "#eae8fd",
                                  padding: "11px 5px",
                                  borderradius: "10px"
                                }}><i data-feather='folder-plus'></i></i>
                              </div>
                              <div class="">
 ...
 */}
              {/* <Logos/> */}
              <div className='logo_heading' style={{}}><h1 style={{
                textAlign: "center",
                fontWeight: "700"
              }}>
