...
const ManagerComplaint = () => {
    ...
    const fetchSupervisorComplaints = async () => {
        try {
            const response = await fetch(`https://api.ezitech.org/manager-complaints?id=${user.int_id}`);
            if (!response.ok) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://api.ezitech.org/intern-manager-complaint', {
                method: 'POST',
                headers: {
                    ...
                    <div className="content-body mt-3">
                        <div className="card">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                <h4 className="card-title mb-0">Manager Complaints</h4>
                                <p style={
                                    {
                                        fontSize:'10px'
                                    }
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Submit Manager Complaint</h5>
                                <button
                                    type="button"
                                    className="close"
